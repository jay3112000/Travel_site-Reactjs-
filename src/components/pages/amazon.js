...
function amazon() {
             ...
             return(
                ...
                className='amazon'
                src={"https://upload.wikimedia.org/wikipedia/commons/thumb/7/73/Amazon_CIAT_%282%29.jpg/1280px-Amazon_CIAT_%282%29.jpg"} alt="Logo" />
                <div
    
                className='amazon-image-text'
                >
                 <h1
