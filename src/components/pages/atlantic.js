...
function atlantic() {
             ...
             return(
                 <div className='atlantic-container' >
                <img 
                
                className='atlantic'
                src={"https://static.toiimg.com/thumb/msid-53331161,width-748,height-499,resizemode=4,imgsize-190155/.jpg"} alt="Logo" />
                <div
    
                className='atlantic-image-text'
                >
                 <h1
